...
struct bitfury_info {
	...
	int osc6_bits;
	struct bitfury_payload payload[MAX_NUM_OF_CHIPS];
	unsigned oldbuf[17 * MAX_NUM_OF_CHIPS];
	bool job_switched[MAX_NUM_OF_CHIPS];
	bool second_run[MAX_NUM_OF_CHIPS];
	struct work *work[MAX_NUM_OF_CHIPS];
	struct work *owork[MAX_NUM_OF_CHIPS];
